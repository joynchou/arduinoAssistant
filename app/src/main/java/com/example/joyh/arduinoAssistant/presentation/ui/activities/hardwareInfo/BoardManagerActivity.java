...
public class BoardManagerActivity extends SwipeBackActivity
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DownloadableBoardFragment downloadableBoardFragment=new DownloadableBoardFragment();
        DownloadedBoardFragment downloadedBoardFragment=new DownloadedBoardFragment();
...
//        adapter = new DownloadableRecyclerViewAdapter(this, imgURL, boardname, content, boardRepository, this);
//        callback = adapter.getCallback();
//        recyclerView.setAdapter(adapter);
//        if (sysVersion <= 18) {
//            recyclerView.addItemDecoration(new DividerItemDecoration(BoardManagerActivity.this, DividerItemDecoration.VERTICAL));
//        }
