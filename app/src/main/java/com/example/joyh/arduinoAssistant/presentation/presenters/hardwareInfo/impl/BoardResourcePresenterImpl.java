...
public class BoardResourcePresenterImpl extends AbstractPresenter implements BoardResourcePresenter,
        ...
        ShareResourceInteractor.Callback
{
    ...
    @Override
    public void onShareResource(String resourceName, int resourceType) {
        view.onViewShareResource();
    }

    @Override
    public void PresenterShowBoardDetailList(String boardName) {
        boardDetailListInteractor.InteractorShowBoardDetailList(boardName);
    }

    @Override
    public void PresenterItemClicked(BoardBeanModel boardBeanModel) {
        boardDetailListInteractor.InteractorItemClicked(boardBeanModel);
    }

    @Override
    public void PresenterShareClicked(BoardBeanModel boardBeanModel) {
